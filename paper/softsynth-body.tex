...
\todo[inline]{Note to Eddie from Tom: Are you sure the memory error problems are only due to the web service? My understanding is that MH will always have problems with more than a handful of predicates, because it makes the search space exponentially larger. If this is the case, I would change the preceeding paragraph accordingly.}
